...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (menuSublinks.length) menuSublinks.forEach((menuSublink => {
                ...
                menuSublink.addEventListener("click", (e => {
                    if (isMobile.any()) {
                        ...
                        if (menuSubmenu.classList.contains("_active")) _slideDown(menuSubmenu); else _slideUp(menuSubmenu);
                    }
                }));
            }));
        ...
        function submenuHidden(menuSubmenu) {
            if (isMobile.any()) menuSubmenu.hidden = true; else menuSubmenu.hidden = false;
        }
