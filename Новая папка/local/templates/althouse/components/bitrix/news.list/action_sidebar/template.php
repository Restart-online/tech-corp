...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	$file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"], array('width'=>360, 'height'=>280), BX_RESIZE_IMAGE_EXACT);    						
	?>
	<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="interesting" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
