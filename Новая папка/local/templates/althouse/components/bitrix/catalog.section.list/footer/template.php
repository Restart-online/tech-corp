	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li id="<?=$this->GetEditAreaId($arSection['ID']);?>" class="contacts-footer__li"><a href="<? echo $arSection["SECTION_PAGE_URL"]; ?>" class="contacts-footer__link"><? echo $arSection["NAME"];?><?
				if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null)
				{
					?> <span>(<? echo $arSection["ELEMENT_CNT"]; ?>)</span><?
				}
