...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<?
	if($first) {
		$file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]['ID'], array('width'=>780, 'height'=>756), BX_RESIZE_IMAGE_EXACT);    
	?>
		<div class="info-item info-item--full" id="<?=$this->GetEditAreaId($arItem['ID']);?>">			
	<?
		$first = false;
	} else {
		$file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]['ID'], array('width'=>360, 'height'=>270), BX_RESIZE_IMAGE_EXACT);    
	?>
