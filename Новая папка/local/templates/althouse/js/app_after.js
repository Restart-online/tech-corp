 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (document.querySelectorAll(".menu__sublink._spoller-active").length) document.querySelectorAll(".menu__sublink._spoller-active").forEach((e => {
        ...
        function initSliders() {
            if (document.querySelector(".about-docs__slider")) new core(".about-docs__slider", {
...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (menuSublinks.length) headerSubMenuActions(menuSublinks);
                ...
                menuSublink.addEventListener("click", (e => {
                    ...
                    if (menuSubmenu.classList.contains("_active")) {
                        setTimeout((() => {
                            ...
                            document.documentElement.classList.remove("submenu-open");
                            if (window.innerWidth > 767) bodyUnlock();
                        }), 300);
                        ...
                        if (window.innerWidth > 767) bodyLock();
        ...
        function directionsSearch(directionsInput) {
            ...
            if (directionsInputIcon) directionsInputIcon.addEventListener("click", (() => {
        ...
        function directionSearchInput(directionsInput, directionsItems, servicesNavigation, servicesItems, servicesItemsParent, directionsInputIcon) {
            ...
            directionsItems.forEach((directionsItem => {
                ...
                if (directionsInputValue.length > 0) {
                    ...
                    if (arr.length > 0) {
                        if (directionsResult) directionsResult.innerHTML = `Количество найденных совпадений: ${arr.length}`;
                        if (servicesItemsParent) servicesItems.forEach((el => {
                            el.querySelector(".item-services__back").hidden = true;
                        }));
                    } else {
                        if (directionsResult) {
        ...
        function submenuHidden(menuSubmenu) {
            if (!menuSubmenu.classList.contains("_active")) menuSubmenu.hidden = true; else menuSubmenu.hidden = false;
        }
        ...
        document.addEventListener("afterPopupOpen", (function(e) {
            ...
            if (currentPopup.targetOpen.element.classList.contains("blueButtonPopup")) {
                ...
                if (currentPopup.lastFocusEl) if (currentPopup.lastFocusEl.getAttribute("data-popup-info")) {
                    let popupInfo = currentPopup.lastFocusEl.getAttribute("data-popup-info");
                    popupTitle.innerHTML = popupInfo;
                    if (popupInput) popupInput.value = popupInfo;
                } else {
                    setTimeout((() => {
            ...
            this.init = function() {
                for (let i = 0; i < this.accordionItems.length; i++) {
                    ...
                    accordionTitle.addEventListener("click", (() => {
                        if (this.accordionItems[i].classList.contains(this.accordionOpenClass)) this.close(this.accordionItems[i]); else {
                            if (!this.multiple) for (let j = 0; j < this.accordionItems.length; j++) this.close(this.accordionItems[j]);
                            this.open(this.accordionItems[i]);
                        }
                    }));
                }
                for (let index of this.opened) this.open(this.accordionItems[index]);
            };
        ...
        const files_accordion = EvilAccordion;
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            accordions.forEach((accordion => new files_accordion(accordion, {
                opened: [ 0 ]
            })));
            const gallery = new core(gallerySelector, {
                modules: [ EffectFade ],
                loop: true,
                effect: "fade",
                allowTouchMove: false
            });
            new core(carouselSelector, {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            new core(historySliderSelector, {
                modules: [ Navigation ],
                centeredSlides: true,
                slidesPerView: 5,
                initialSlide: 2,
