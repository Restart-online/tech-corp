...
while($arElement = $rsElements->GetNext())
{	
	$arResult["TEMP"][$arElement["IBLOCK_SECTION_ID"]]["ELEMENT_LIST"][] = $arElement;
}
#echo '<pre style="">';print_r($arResult["TEMP"]);echo '</pre>';
foreach($arResult["SECTIONS"] as $arSection)
{
	...
	$aMenuLinksNew[$menuIndex++] = array(
		...
		array(
			"FROM_IBLOCK" => true,
			"IS_PARENT" => (!isset($arResult["TEMP"][$arSection["ID"]]["ELEMENT_LIST"]) ? false : true),
			"DEPTH_LEVEL" => $arSection["DEPTH_LEVEL"],
		),
	);
	#echo '<pre style="">';print_r((isset($arResult["TEMP"][$arSection["ID"]]["ELEMENT_LIST"]) ? 1 : 0));echo '</pre>';
	foreach($arResult["TEMP"][$arSection["ID"]]["ELEMENT_LIST"] as $arElement) {
		$aMenuLinksNew[$menuIndex++] = array(
...
#echo '<pre style="">';var_dump($aMenuLinksNew);echo '</pre>';
